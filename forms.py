...
class submit_ep_form(Form):
    ...
    audio_upload_option = BooleanField('upload_audio_to_server?', default=True)
    audio_upload_to_ia_option = BooleanField('upload_audio_to_internet_archive?', default=True)
